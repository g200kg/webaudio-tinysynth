...
// 35
    ...
    program1:[
      ...
      [{w:"square",v:0.1,a:1,s:1,d:0.15,r:0.15,p:1},{w:"sine",v:17,t:15,a:0.1,d:1,s:1,r:0.07,g:1},{w:"sine",v:11,t:11,a:0.1,b:3123,d:1,s:1,r:0.07,g:1}],
      /* 121-128 : SE */
...
/*35*/  [{w:"triangle",t:0,f:66,v:2,d:0.02,h:0.03,p:0.9,r:0.02,},{w:"square",g:1,t:10.1,v:22,r:0.002,c:0,h:0,p:0,d:0.002,}],//[{w:"triangle",t:0,f:73,v:1.5,d:0.02,h:0.02,p:0.3,r:0.02,},{w:"triangle",g:1,t:0,f:622,v:16,r:0.01,c:0,h:0,p:0.5,}],
        ...
        [{w:"sine",f:191,v:0.5,d:0.03,p:0.9,t:0,r:0.03,h:0.03,},{w:"square",v:0.6,t:0,f:722,h:0.015,r:0.01,b:3323,c:0,p:0,}],
...
/*45*/  [{w:"triangle",f:250,v:0.9,d:0.12,h:0.02,p:0.5,t:0,r:0.12,},{g:1,w:"square",v:5,t:3,h:0.015,d:0.005,r:0.005,b:2551,c:0,}],
        ...
        [{w:"square",f:720,v:0.3,d:0.22,r:0.22,h:0.05,t:0,p:1.2,},{w:"square",g:1,t:1.75,v:3.8,d:0.22,s:1.2,r:0.22,b:1551,c:0,h:0.05,a:0.1,}],
...
/*80*/[{w:"sine",t:0,f:1200,v:0.3,r:0.01,}],
    ...
    note:function(t,ch,n,v,p){  /* note trigger */
      ...
      var i,out,sc;
      for(i=this.notetab.length-1;i>=0;--i){
        var nt=this.notetab[i];
        if(nt.ch==ch && nt.n==n){
          nt.e=t;
          nt.f=1;
      ...
      for(i=0;i<p.length;++i){
        ...
        if(pn.b){
          ...
          var d3=this.actx.createDelay(256/this.actx.sampleRate); // workaround for Firefox
          o[i].connect(g3);
          g3.gain.setValueAtTime(pn.b,t);
          g3.connect(d3);
          d3.connect(o[i].frequency);
        }
        if(pn.p!=1)
        ...
        case 124: case 125: case 126: case 127: /* omni off/on mon/poly */
          ...
          for(var i=this.notetab.length-1;i>=0;--i){
            ...
            for(var j=nt.o.length-1;j>=0;--j){
              nt.o[j].disconnect();
              nt.o[j].frequency.cancelScheduledValues(0);
              nt.o[j].stop();
            }
            nt.e=t+0.1;
            this.notetab.splice(i,1);
