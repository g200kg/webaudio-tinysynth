# webaudio-tinysynth
WebAudio Tiny GM mapped Synthesizer [Polymer]
...
- There are two versions. Polymer dom-module version and simple JavaScript library version.
  Polymer version can be used by a Tag, '&lt;webaudio-tinysynth&gt;'. It has small graphical wave display and MIDI file drop acceptable. JavaScript version has no GUI.<br/><br/>
- The API is MIDI like. Function  `send([midi-message],timestamp)` receives MIDI message data and generate sounds.<br/><br/>
- Two timbre set are supported. 1 oscillator per 1 note ('quality=0', light-weight, chiptune like sounds), or 2 or more oscillators for 1 note ('quality=1', FM based sounds).<br/><br/>
...
* Then use the function call described later for that instance. For example...  
