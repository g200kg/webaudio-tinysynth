...
- There are two versions. Polymer dom-module version and simple JavaScript library version.
  Polymer version can be used by a Tag, '&lt;webaudio-tinysynth&gt;'. It has small graphical display and play controls like HTML5 &lt;audio&gt; tags. MIDI file drop is also acceptable. JavaScript version has no GUI and everything are controlled by function call.
...
## Environment
  ...
  * Chrome / Firefox / Edge / iOS Safari
