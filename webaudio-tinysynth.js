...
/*35*/  [{w:"triangle",t:0,f:66,v:1,d:0.02,h:0.03,p:0.9,r:0.02,},{w:"square",g:1,t:10.1,v:22,r:0.002,h:0,p:0,d:0.002,}],
        ...
        [{w:"sine",v:.4,f:180,d:0.04,t:0,r:0.04,h:0.03,},{w:"n0",v:0.6,t:0,f:70,h:0.02,r:0.01,p:0,}],
...
/*80*/[{w:"sine",t:0,f:1200,v:0.3,r:0.01,}],
    ...
    ready:function(){
      ...
      this.releaseRatio=3;
      for(var i=0;i<16;++i){
        this.pg[i]=0; this.vol[i]=100*100/(127*127);
    ...
    reset:function(){
      for(var i=0;i<16;++i){
        this.pg[i]=0; this.vol[i]=100*100/(127*127); this.bend[i]=0;
